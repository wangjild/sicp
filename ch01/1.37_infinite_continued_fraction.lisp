...
(format t "~,10F~%" (cont-frac (lambda (x) (+ 1.0 0)) (lambda (x) (+ 1.0 0)) 10))

(format t "~,10F~%" (cont-frac (lambda (x) (+ 1.0 0)) (lambda (x) (+ 1.0 0)) 11))
...
(format t "~,10F~%" (cont-frac-iter (lambda (x) (+ 1.0 0)) (lambda (x) (+ 1.0 0)) 11))
